...
Migrado desde apps.chat a apps.internal
"""
...
# Importar modelos desde apps.chat
...
# Importar forms desde internal/forms/chat
from apps.internal.forms.chat.forms import (
    AgentConfigForm,
    AgentPromptForm,
    AgentToolForm,
...
def agent_list(request):
    ...
    return render(request, 'internal/chat/agents/agent_list.html', context)
...
def agent_detail(request, agent_id):
    ...
    return render(request, 'internal/chat/agents/agent_detail.html', context)
...
def agent_create(request):
    ...
    return render(request, 'internal/chat/agents/agent_form.html', {
        'form': form,
...
def tools_library(request):
    ...
    from apps.chat.models.common_tools import CommonTool, ToolCategory
    from django.db.models import Q
    ...
    return render(request, 'internal/chat/tools/tools_library.html', context)


@login_required
def tool_detail(request, tool_name):
    """Detalle de una herramienta específica"""
    from apps.chat.models.common_tools import AgentToolAssignment, CommonTool
    ...
    try:
        ...
        return redirect('internal:chat:tools_library')
    ...
    return render(request, 'internal/chat/tools/tool_detail.html', context)
...
def agent_tools(request, agent_id):
    ...
    from apps.chat.models.common_tools import AgentToolAssignment, CommonTool, ToolCategory
    ...
    return render(request, 'internal/chat/agents/agent_tools.html', context)
...
def assign_tool_to_agent(request, agent_id):
    ...
    from apps.chat.models.common_tools import CommonTool, AgentToolAssignment
...
def remove_tool_from_agent(request, agent_id, assignment_id):
    ...
    from apps.chat.models.common_tools import AgentToolAssignment
...
def test_agent(request, agent_id):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            import time
            import json
            from apps.chat.agents import create_dynamic_agent
            ...
            return render(request, 'internal/chat/agents/test_result.html', {
                'agent': agent,
                'form': form,
                'result': test_result
            })
    ...
    return render(request, 'internal/chat/agents/test_agent.html', context)
...
#         'prompts': prompts
#     }
#     return render(request, 'internal/chat/agents/agent_prompts.html', context)
...
def create_prompt(request, agent_id):
    ...
    return render(request, 'internal/chat/prompts/prompt_form.html', {
        'form': form,
        'agent': agent,
        'title': title
    })
...
def admin_dashboard(request):
    ...
    from apps.chat.models.conversation import Conversation, ConversationMessage
    ...
    return render(request, 'internal/chat/admin/dashboard.html', context)
...
def agent_context_files(request, agent_id):
    ...
    from apps.chat.models import AgentConfig, ContextFile, AgentContextAssignment
    ...
    return render(request, 'internal/chat/agents/context_files.html', context)
...
def enhance_prompt_api(request, agent_id):
    ...
    try:
        import json
        from apps.chat.services.prompt_enhancer import enhance_prompt_content
...
def delete_prompt_api(request, agent_id, prompt_id):
    ...
    try:
        from apps.chat.models import AgentConfig, AgentPrompt
...
def conversation_list(request):
    ...
    return render(request, 'internal/chat/conversations/conversation_list.html', context)
...
def conversation_detail(request, conversation_id):
    ...
    return render(request, 'internal/chat/conversations/conversation_detail.html', context)
...
def add_assistant_message(request, conversation_id):
    ...
    try:
        ...
        if request.content_type == 'application/json':
            ...
            return redirect('internal:chat:conversation_detail', conversation_id=conversation_id)
...
def conversation_archive(request, conversation_id):
    ...
    try:
        ...
        return redirect('internal:chat:conversation_list')
...
def conversation_analytics(request):
    ...
    return render(request, 'internal/chat/conversations/conversation_analytics.html', context)